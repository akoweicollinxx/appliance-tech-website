...
const Contact = () => {
  return (
    <div className='max-w-[1000px] mx-auto flex flex-col lg:flex-row text-white/70 mt-15  rounded-lg space-y-8 lg:space-y-0 lg:space-x-8' id='contact'>
      <div className='flex justify-center items-center'>
        <ul className='space-y-4'>
            <li className='flex items-center'>
                <Image src={phone} alt='phone' className='h-[110px] w-auto mr-6' />
                <p className='text-xl'>072 909 7869</p>
            </li>
            <li className='flex items-center'>
      ...
      <div className='bg-white/10 p-6 rounded-xl max-w-[550px]'>
          ...
          <p className='text-white/70 mb-6'>Send Us a Message to Schedule a call!</p>
          <form className='space-y-4' action="https://getform.io/f/bkkynonb" method='POST'>
